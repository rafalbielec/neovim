...
windline.setup({
	colors_name = function(colors)
		...
		local normal_color = colors.green
		local insert_color = colors.cyan

		colors.magenta_a = mod(normal_color, 0.0)
		colors.magenta_b = mod(normal_color, 0.2)
		colors.magenta_c = mod(normal_color, 0.4)
		...
		colors.green_a = mod(insert_color, 0.2)
		colors.green_b = mod(insert_color, 0.5)
		colors.green_c = mod(insert_color, 0.7)
